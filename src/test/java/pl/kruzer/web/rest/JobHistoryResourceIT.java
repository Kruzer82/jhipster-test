package pl.kruzer.web.rest;

import pl.kruzer.JhipsterTestApp;
import pl.kruzer.domain.JobHistory;
import pl.kruzer.repository.JobHistoryRepository;
import pl.kruzer.repository.search.JobHistorySearchRepository;
import pl.kruzer.service.JobHistoryService;
...
import pl.kruzer.domain.enumeration.Language;
/**
...
public class JobHistoryResourceIT {
    ...
    /**
     * This repository is mocked in the pl.kruzer.repository.search test package.
     *
     * @see pl.kruzer.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
