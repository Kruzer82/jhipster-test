...
import pl.kruzer.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link pl.kruzer.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class JobResource {
    ...
    private static final String ENTITY_NAME = "jhipsterTestJob";
